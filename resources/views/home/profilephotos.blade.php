	...
	<article class="box-typical profile-post">
		<div class="row" style="margin-bottom:25px">
			...
			@foreach($photos as $photo)
				<div class="col-md-2" style="height: 150px" id="photo-block-{{ $photo->id }}">
					<img  class="img img-thumbnail image " id="myImg-{{$photo->id}}" photo-id="{{$photo->id}}"  style="padding: 3px; border: 1px solid blue;margin:5px"" src="/images/{{ $photo->photo.'_tumbinal'.$photo->extension }}"  height="171px" width="171px" alt="no pic">
		...
		<div id="myModal" class="modal">
			...
			<div class="carousel-inner">
					<div class="item active activeimage">
						
					</div>
					@foreach($photos as $photo)
						<div class="item" class="photoid">
